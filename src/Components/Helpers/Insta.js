// const dataInstaPermalink = "https://www.instagram.com/p/Ck049AgByQy/?utm_source=ig_embed&amp;utm_campaign=loading";
// const linkAHref_1 = "https://www.instagram.com/p/Ck049AgByQy/?utm_source=ig_embed&amp;utm_campaign=loading";
// const linkAHref_2 = "https://www.instagram.com/p/Ck049AgByQy/?utm_source=ig_embed&amp;utm_campaign=loading";

function InstaPost ({ dataInstaPermalink, linkAHref_1, linkAHref_2 }) {
    return (
        <blockquote className="instagram-media" data-instgrm-permalink={dataInstaPermalink}
        data-instgrm-version="14"
        style={{background: "#ffffff", border: 0, borderRadius: "3px", boxShadow: "0 0 1px 0 rgba(0,0,0,0.5),0 1px 10px 0 rgba(0,0,0,0.15)",
                margin: "1px", maxWidth: "540px", minWidth: "326px", padding: 0, width: "99.375%", width: "-webkit-calc(100% - 2px)", width: "calc(100% - 2px)"}}>
            <div style={{padding: "16px"}}> 
                ...
                <p style={{color: "#c9c8cd", fontFamily: "Arial,sans-serif", fontSize: "14px", lineHeight: "17px", marginBottom: 0, marginTop: "8px", overflow: "hidden", padding: "8px 0 7px", textAlign: "center", textOverflow: "ellipsis", whiteSpace: "nowrap"}}>
                    ...
                    target="_blank" rel="noreferrer noopenner">A post shared by P W H (@pwh_27)
                    </a>
                </p>
            </div>
        </blockquote>
...
// dataInstgrmPermalink = https://www.instagram.com/p/Ck049AgByQy/?utm_source=ig_embed&amp;utm_campaign=loading
// linkAHref_1 = https://www.instagram.com/p/Ck049AgByQy/?utm_source=ig_embed&amp;utm_campaign=loading
// linkAHref_2 = https://www.instagram.com/p/Ck049AgByQy/?utm_source=ig_embed&amp;utm_campaign=loading

function InstaPostCaption ({ dataInstgrmPermalink, linkAHref_1, linkAHref_2 }) {
    return (
        <blockquote
        className="instagram-media"
        data-instgrm-captioned
        data-instgrm-permalink={dataInstgrmPermalink}
        data-instgrm-version="14"
        style={{background: "#ffffff", border: 0, borderRadius: "3px", boxShadow: "0 0 1px 0 rgba(0,0,0,0.5),0 1px 10px 0 rgba(0,0,0,0.15)",
        margin: "1px", maxWidth: "540px", minWidth: "326px", padding: 0, width: "99.375%", width: "-webkit-calc(100% - 2px)", width: "calc(100% - 2px)"}}>
            <div style={{padding: "16px"}}>
...
export { InstaPost, InstaPostCaption };